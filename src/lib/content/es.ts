...
export const es: LandingContent = {
	...
	terms: {
		...
		scopeNoteHtml:
			'Estos términos de servicio cubren (a) el propio sitio de marketing/documentación y (b) la oferta gestionada en la nube, donde realmente operamos infraestructura y existe una relación contractual real. <strong>No</strong> cubren los despliegues autoalojados: una empresa que se autoaloja está ejecutando su propia copia de software de código abierto bajo AGPLv3, y es ella misma responsable de los términos que establezca con sus propios empleados.',
		disclaimerHtml:
			'Este es un primer borrador estructurado, no un texto legal definitivo. Todavía no ha sido revisado por un abogado, y no debería considerarse un acuerdo vinculante hasta que lo sea.',
		sections: [
			{
				heading: '1. Aceptación de los términos',
				bodyHtml: 'Usar el sitio o el servicio en la nube implica aceptar estos términos.'
			},
			{
				heading: '2. El software frente al servicio',
				bodyHtml:
					'Existe una distinción clara entre el software de código abierto —cuyo uso se rige por la licencia AGPLv3, no por estos términos— y el servicio en la nube, un producto gestionado regido por estos términos y por un Acuerdo de Procesamiento de Datos independiente.'
			},
			{
				heading: '3. Términos de la cuenta',
				bodyHtml:
					'Quién puede crear una cuenta en la nube, el uso aceptable y las condiciones bajo las cuales una cuenta puede ser suspendida.'
			},
			{
				heading: '4. Suscripción y facturación',
				bodyHtml:
					'Cubre los niveles Plus y Enterprise: ciclo de facturación, qué ocurre en caso de impago, política de reembolsos, y cómo se aplican los límites de nivel (número de usuarios, retención de historial), incluido qué ocurre si se superan.'
			},
			{
				heading: '5. Propiedad de los datos',
				bodyHtml:
					'El cliente es propietario de sus datos. encrypted1on1, como operador de la nube, no puede leer el contenido de las reuniones 1 a 1 por diseño, y esto se indica explícitamente aquí, no solo en la Política de Privacidad.'
			},
			{
				heading: '6. Disponibilidad del servicio',
				bodyHtml:
					'Expectativas de tiempo de actividad y cualquier SLA (solo para el nivel Enterprise, cuando aplique), y ventanas de mantenimiento.'
			},
			{
				heading: '7. Terminación',
				bodyHtml:
					'Cualquiera de las partes puede poner fin a la relación. Cubre qué ocurre con los datos de un cliente al cerrar la cuenta, y la ventana de exportación disponible antes de la eliminación.'
			},
			{
				heading: '8. Limitación de responsabilidad',
				bodyHtml:
					'Se aplican los límites de responsabilidad estándar de SaaS; los términos exactos requieren una redacción legal real.'
			},
			{
				heading: '9. Cambios en estos términos',
				bodyHtml: 'Plazo de aviso y forma en que se informa a los clientes de los cambios.'
			},
			{
				heading: '10. Ley aplicable / jurisdicción',
				bodyHtml:
					'Pendiente de determinar, probablemente vinculada a la jurisdicción donde esté constituida la entidad operadora.'
			}
		]
	},
	...
	privacyPolicy: {
		...
		scopeNoteHtml:
			'Esta política cubre el sitio de marketing y el servicio en la nube. Los despliegues autoalojados se rigen por la propia política de privacidad de la organización que los despliega; el propio producto cuenta con un enlace configurable en el pie de página exactamente para este propósito (ver <a href="' +
			DEPLOYMENT_DOCS_URL +
			'" target="_blank" rel="noopener noreferrer">la documentación de despliegue</a>).',
		disclaimerHtml:
			'Este es un primer borrador estructurado, no un texto legal definitivo. Todavía no ha sido revisado por un abogado, y no debería considerarse una descripción vinculante de nuestras prácticas hasta que lo sea.',
		sections: [
			{
				heading: '1. Qué cubre esta política',
				bodyHtml:
					'El sitio de marketing y el servicio en la nube. Los despliegues autoalojados se rigen por la propia política de privacidad de la organización que los despliega (ver la nota de alcance anterior).'
			},
			{
				heading: '2. Qué podemos ver técnicamente y qué no podemos ver',
				bodyHtml:
					'Esta es la sección más importante de esta página. Metadatos que podemos ver: quién habla con quién, fechas de las reuniones, correos electrónicos de las cuentas. Contenido que no podemos ver estructuralmente, gracias al cifrado de extremo a extremo: respuestas, retroalimentación, comentarios, hitos de objetivos. Para el lector técnico que quiera el modelo de amenazas real, no solo el resumen, ver <a href="' +
					ENCRYPTION_DOCS_URL +
					'" target="_blank" rel="noopener noreferrer">nuestra documentación de cifrado</a>.'
			},
			{
				heading: '3. Datos del sitio de marketing',
				bodyHtml:
					'En este sitio no se ejecuta ninguna herramienta de analítica o rastreo de terceros. La privacidad prevalece sobre la comodidad del seguimiento de conversiones: un producto centrado en la privacidad que ejecutara analítica de terceros en su propio sitio supondría una brecha de credibilidad real y fácilmente detectable, precisamente para la audiencia con más probabilidades de comprobarlo. Si alguna vez se añade analítica, será una herramienta autoalojada o respetuosa con la privacidad (por ejemplo, Plausible, Fathom, Umami: sin cookies de terceros, sin seguimiento entre sitios), y esta sección lo indicará con claridad. No hace falta un aviso de cookies mientras esto se mantenga así; sencillamente no hay nada a lo que dar consentimiento. La única excepción es el widget de reservas de Cal.com utilizado para «Reservar una demo»; este se declara más abajo como subencargado del tratamiento, en lugar de incluirse en «sin analítica», ya que es el mecanismo real de una solicitud que tú realizas, no un rastreador.'
			},
			{
				heading: '4. Datos del servicio en la nube',
				bodyHtml:
					'Datos de la cuenta (correo electrónico, material de autenticación con hash, nunca la contraseña real ni la clave maestra, que nunca salen de tu navegador), datos de facturación para los niveles de pago (a través de un proveedor de pagos externo, que se indicará una vez elegido), y registros del servidor con su período de retención.'
			},
			{
				heading: '5. Ubicación de los datos',
				bodyHtml:
					'Dónde se aloja físicamente la infraestructura en la nube está aún por decidir; esto importa especialmente a los clientes con requisitos del RGPD.'
			},
			{
				heading: '6. Subencargados del tratamiento',
				bodyHtml:
					'Uno ya está decidido y es real: <strong>Cal.com</strong>, utilizado para el flujo de captación de leads de «Reservar una demo»; gestiona el nombre, el correo electrónico y la empresa de cualquiera que reserve una llamada. El resto (proveedor de alojamiento, proveedor de pagos, proveedor de entrega de correo) se indicará aquí una vez elegidos esos proveedores.'
			},
			{
				heading: '7. Derechos de los interesados',
				bodyHtml:
					'Acceso, exportación y eliminación. El producto ya cuenta con eliminación de cuenta y exportación de datos de autoservicio para los despliegues autoalojados; la versión en la nube ofrecerá lo mismo.'
			},
			{
				heading: '8. Retención de datos',
				bodyHtml:
					'Vinculada a los niveles de precios anteriores: el nivel gratuito en la nube conserva 3 meses de historial, Plus y Enterprise lo conservan indefinidamente. «Retención» aquí significa eliminación real, no simplemente ocultar datos antiguos de la interfaz.'
			},
			{
				heading: '9. Prácticas de seguridad',
				bodyHtml:
					'Cifrado de extremo a extremo para el contenido, además de prácticas estándar para los metadatos que sí nos son visibles: cifrado en reposo y en tránsito, y controles de acceso.'
			},
			{
			...
			},
			{
				heading: '11. Contacto',
				bodyHtml:
					'Aquí se indicará un método de contacto real para preguntas y solicitudes relacionadas con la privacidad en cuanto exista.'
			}
		]
	}
};
